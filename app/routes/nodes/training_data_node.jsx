...
function TrainingDataNode({ data }) {
  let name = '';
  if (data?.ner) name = data?.ner;
  

  return (
    <>
      <div className={`px-4 py-2 min-w-[200px] shadow-md rounded-full bg-trainingDataBg border-2 border-trainingData flex flex-col items-center justify-center`}>
...
export default memo(TrainingDataNode);
