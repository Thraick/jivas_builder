...
function NerResponseNode({ data }) {
  ...
  return (
    <>
      <div className={`px-4 py-2 min-w-[200px] shadow-md rounded-full bg-nerResponseBg border-2 border-nerResponse flex flex-col items-center justify-center`}>
...
export default memo(NerResponseNode);
