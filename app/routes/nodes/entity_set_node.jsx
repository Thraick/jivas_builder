...
function EntitySetNode({ data }) {
  ...
  return (
    <>
      <div className={`px-4 py-2 min-w-[200px] shadow-md rounded-full bg-entitySetBg border-2 border-entitySet flex flex-col items-center justify-center`}>
...
export default memo(EntitySetNode);
