...
function PromptNode({ data }) {
  let name = '';
  if (data?.prompt) name = data?.prompt;
  

  return (
    <>
      <div className={`px-4 py-2 min-w-[200px] shadow-md rounded-full bg-promptBg border-2 border-prompt flex flex-col items-center justify-center`}>
