...
function QaStateNode({ data }) {
  ...
  return (
    <>
      <div className={`px-4 py-2 min-w-[200px] shadow-md rounded-full bg-qaStateBg border-2 border-qaState flex flex-col items-center justify-center`}>
...
export default memo(QaStateNode);
