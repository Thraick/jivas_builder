...
function AdapterNode({ data }) {
  ...
  return (
    <>
      <div className={`px-4 py-2 min-w-[200px] shadow-md rounded-full bg-adapterBg border-2 border-adapter flex flex-col items-center justify-center`}>
