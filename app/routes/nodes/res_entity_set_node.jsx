...
function ResEntitySetNode({ data }) {
  let name = '';
  if (data?.entity) name = data?.entity;
  

  return (
    <>
      <div className={`px-4 py-2 min-w-[200px] shadow-md rounded-full bg-resEntitySetBg border-2 border-resEntitySet flex flex-col items-center justify-center`}>
...
export default memo(ResEntitySetNode);
